...
public class AdvancedUtils {
    private static Logger log = LoggerFactory.getLogger(AdvancedUtils.class);
    ...
    public static boolean sendCustomMessage(String accessToken, String jsonMsg) {
        ...
        // 拼接请求地址
        String requestUrl = Urls.custom_send_url;
        requestUrl = requestUrl.replace("ACCESS_TOKEN", accessToken);
        // 发送客服消息
        JSONObject jsonObject = CommonUtils.httpsRequest(requestUrl, "POST", jsonMsg);
    ...
    public static WeixinOauth2Token getOauth2AccessToken(String appId, String appSecret, String code) {
        ...
        // 拼接请求地址
        String requestUrl = Urls.token_bycode_url;
    ...
    public static WeixinOauth2Token refreshOauth2AccessToken(String appId, String refreshToken) {
        WeixinOauth2Token wat = null;
        // 拼接请求地址
        String requestUrl = Urls.refresh_token_url;
        requestUrl = requestUrl.replace("APPID", appId);
    ...
    public static SNSUserInfo getSNSUserInfo(String accessToken, String openId) {
        ...
        // 拼接请求地址
        String requestUrl = Urls.sns_userinfo_url;
    ...
    public static WeixinQRCode createTemporaryQRCode(String accessToken, int expireSeconds, int sceneId) {
        ...
        // 拼接请求地址
        String requestUrl = Urls.qrcode_create_url;
        requestUrl = requestUrl.replace("ACCESS_TOKEN", accessToken);
        // 需要提交的json数据
        String jsonMsg = "{\"expire_seconds\": %d, \"action_name\": \"QR_SCENE\", \"action_info\": {\"scene\": {\"scene_id\": %d}}}";
        // 创建临时带参二维码
        JSONObject jsonObject = CommonUtils.httpsRequest(requestUrl, "POST", String.format(jsonMsg, expireSeconds, sceneId));
    ...
    public static String createPermanentQRCode(String accessToken, int sceneId) {
        ...
        // 创建永久带参二维码
        JSONObject jsonObject = CommonUtils.httpsRequest(requestUrl, "POST", String.format(jsonMsg, sceneId));
    ...
    public static String getQRCode(String ticket, String savePath) {
        ...
        // 拼接请求地址
        String requestUrl = Urls.showqrcode_url;
        requestUrl = requestUrl.replace("TICKET", CommonUtils.urlEncodeUTF8(ticket));
        try {
    ...
    public static WeixinUserInfo getUserInfo(String accessToken, String openId) {
        ...
        // 拼接请求地址
        String requestUrl = Urls.user_info_url;
        requestUrl = requestUrl.replace("ACCESS_TOKEN", accessToken).replace("OPENID", openId);
        // 获取用户信息
        JSONObject jsonObject = CommonUtils.httpsRequest(requestUrl, "GET", null);
    ...
    public static WeixinUserList getUserList(String accessToken, String nextOpenId) {
        ...
        // 拼接请求地址
        String requestUrl = Urls.user_list_url;
    ...
    public static List<WeixinGroup> getGroups(String accessToken) {
        ...
        // 拼接请求地址
        String requestUrl = Urls.groups_ger_url;
        requestUrl = requestUrl.replace("ACCESS_TOKEN", accessToken);
        // 查询分组
        JSONObject jsonObject = CommonUtils.httpsRequest(requestUrl, "GET", null);
    ...
    public static WeixinGroup createGroup(String accessToken, String groupName) {
        ...
        // 拼接请求地址
        String requestUrl = Urls.groups_create_url;
        requestUrl = requestUrl.replace("ACCESS_TOKEN", accessToken);
        // 需要提交的json数据
        String jsonData = "{\"group\" : {\"name\" : \"%s\"}}";
        // 创建分组
        JSONObject jsonObject = CommonUtils.httpsRequest(requestUrl, "POST", String.format(jsonData, groupName));
    ...
    public static boolean updateGroup(String accessToken, int groupId, String groupName) {
        boolean result = false;
        // 拼接请求地址
        String requestUrl = Urls.groups_update_url;
        requestUrl = requestUrl.replace("ACCESS_TOKEN", accessToken);
        // 需要提交的json数据
        String jsonData = "{\"group\": {\"id\": %d, \"name\": \"%s\"}}";
        // 修改分组名
        JSONObject jsonObject = CommonUtils.httpsRequest(requestUrl, "POST", String.format(jsonData, groupId, groupName));
    ...
    public static boolean updateMemberGroup(String accessToken, String openId, int groupId) {
        boolean result = false;
        // 拼接请求地址
        String requestUrl = Urls.groups_members_update_url;
        requestUrl = requestUrl.replace("ACCESS_TOKEN", accessToken);
        // 需要提交的json数据
        String jsonData = "{\"openid\":\"%s\",\"to_groupid\":%d}";
        // 移动用户分组
        JSONObject jsonObject = CommonUtils.httpsRequest(requestUrl, "POST", String.format(jsonData, openId, groupId));
    ...
    public static WeixinMedia uploadMedia(String accessToken, String type, String mediaFileUrl) {
        ...
        String uploadMediaUrl = Urls.media_upload_url;
    ...
    public static String getMedia(String accessToken, String mediaId, String savePath) {
        ...
        String requestUrl = Urls.media_get_url;
        ...
        try {
            ...
            // 根据内容类型获取扩展名
            String fileExt = CommonUtils.getFileExt(conn.getHeaderField("Content-Type"));
            // 将mediaId作为文件名
    ...
    public static void main(String args[]) {
        // 获取接口访问凭证
        String accessToken = CommonUtils.getToken(Urls.appId, Urls.appSecret).getAccessToken();

        /**
         * 发送客服消息（文本消息）
         */
        // 组装文本客服消息
        String jsonTextMsg = makeTextCustomMessage("ow6kvxLvX2KiJZxNpf9D3WCfjEiE", "点击查看<a href=\"http://blog.csdn.net/lyq8479\">柳峰的博客</a>");
        // 发送客服消息
        ...
        list.add(article2);
        // 组装图文客服消息
        String jsonNewsMsg = makeNewsCustomMessage("ow6kvxLvX2KiJZxNpf9D3WCfjEiE", list);
        // 发送客服消息
         ...
         * 获取用户信息
         */
        WeixinUserInfo user = getUserInfo(accessToken, "ow6kvxLvX2KiJZxNpf9D3WCfjEiE");
