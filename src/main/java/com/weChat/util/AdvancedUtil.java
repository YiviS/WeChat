...
import com.weChat.entity.message.resp.Article;
import com.weChat.entity.message.resp.Music;
...
public class AdvancedUtil {
    ...
    public static void main(String args[]) {
        // 获取接口访问凭证
        String accessToken = CommonUtil.getToken(Contents.appId, Contents.appSecret).getAccessToken();
